...
二是越养越弱，在严格控制饮食后，胃部不适少了，可以前能吃的东西，现在吃了却开始不舒服了。

养胃App 可以协助用户走出这些困境。

## 工作原理

胃是一个强酸环境，除了幽门螺旋菌外，几乎没有细菌可生存，如果把胃看作一个系统，它当下的状态只受你最近几天的行为的影响。行为有两种，伤胃的和养胃的，当伤胃的活动积累到一定程度，超过了胃自我恢复的能力后，就形成一个伤胃的趋势，即使这时还没有症状，随着时间的推移，胃的状态持续变弱，最终会反映在症状上，让人难受。

我们的目的是，扭转这个趋势，让胃维持在良好状态，或变好变强的趋势中。也就是说，每天行为上对胃的伤害，不能超过胃的恢复能力，否则，即此行为模式不可持续，需要暂停和打断。

养胃App可以根据最近行为打卡，推算出的当前胃的状态，发现下降趋势，在出现症状前，提示用户风险。
...
* 当 App 提示“脆弱/警告/危险”时，不要再做任何伤胃的行为。
